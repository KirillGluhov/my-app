    ...
    /*return (
        <Stack className='border-darkblue'>
            <Row className='mt-3 mx-3'>
                <Col xl={4} lg={4} md={4} sm={6} className='mb-3'>
                ...
                <Col xl={2} lg={4} md={4} sm={6} className='mb-3'>
